...
function disablePoll(poll) {
    ...
    const endpoint = "http://http://ec2-54-193-22-54.us-west-1.compute.amazonaws.com/api/pollsdisable";
...
function deletePoll(id) {
    const endpoint = "http://http://ec2-54-193-22-54.us-west-1.compute.amazonaws.com/api/polls";
