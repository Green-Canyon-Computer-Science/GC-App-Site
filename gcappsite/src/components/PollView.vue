...
function disablePoll(poll) {
    ...
    const endpoint = "http://ec2-18-144-101-122.us-west-1.compute.amazonaws.com/api/pollsdisable";
...
function deletePoll(id) {
    const endpoint = "http://ec2-18-144-101-122.us-west-1.compute.amazonaws.com/api/polls";
